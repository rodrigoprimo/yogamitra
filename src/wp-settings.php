...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'A versão do PHP em seu servidor é %s, mas o WordPress necessita pelo menos da versão 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'Parece que, em sua instalação do PHP, está faltando a extensão MySQL, que é exigida pelo WordPress.'/*/WP_I18N_OLD_MYSQL*/ );
