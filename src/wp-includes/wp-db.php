...
<p>Isso significa que as informações de nome de usuário e senha em seu arquivo <code>wp-config.php</code> estão incorretas ou nós não podemos contatar o servidor do banco de dados em<code>%s</code>. Isso pode significar que o servidor de banco de dados da sua hospedagem está fora do ar.</p>
<ul>
...
<h1>Não é possível selecionar o banco de dados</h1>
<p>Conseguimos conectar ao servidor do banco de dados (o que significa que seu nome de usuário e senha estão corretos), mas não pudemos selecionar o banco de dados <code>%1$s</code>.</p>
<ul>
<li>Você tem certeza de que ele existe?</li>
<li>O usuário <code>%2$s</code> tem permissão para usar o banco de dados <code>%1$s</code>?</li>
<li>Em alguns sistemas, o nome do banco de dados tem como prefixo o seu nome de usuário, logo seria algo como <code>nomedeusuario_%1$s</code>. Pode ser esse o problema?</li>
</ul>
<p>Se não souber como configurar o banco de dados, <strong>entre em contato com sua hospedagem</strong>. Se tudo o mais falhar, procure ajuda nos Fóruns de Suporte do WordPress: <a href="http://wordpress.org/support/">ajuda em inglês</a> e <a href="http://br.forums.wordpress.org/">em português</a>.</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, DB_USER));
			return;
		}
	}
