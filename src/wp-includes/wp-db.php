...
<p>Nós pudemos conectar o servidor do banco de dados (o que significa que seu nome de usuário e senha estão corretos), mas não pudemos selecionar o banco de dados <code>%1$s</code>.</p>
<ul>
...
<p>Se você não sabe como configurar um banco de dados, você deve <strong>contactar sua hospedagem</strong>. Se tudo o mais falhar você pode encontrar ajuda nos Fóruns de Suporte do WordPress: <a href="http://wordpress.org/support/">ajuda em inglês</a> e <a href="http://br.forums.wordpress.org/">em português</a>.</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, DB_USER));
			return;
		}
	}
